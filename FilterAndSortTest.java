...
class FilterAndSort {
    static <T> List<T> execute(List<T> list, Predicate<T> predicate) {
    ...
    public static void main(String[] args) {
        ...
        if (testCase == 1) { // students
            ...
            if (studentScenario == 1) {
                ...
                List<Student> filteredStudents = FilterAndSort.execute(students,predicate);
                filteredStudents.sort(Comparator.comparing(Student::labAssistantPoints).reversed());
            ...
            List<Integer> filteredIntegers = FilterAndSort.execute(integers,predicate);
            filteredIntegers.sort(Comparator.reverseOrder());
            filteredIntegers.forEach(System.out::println);
        }
